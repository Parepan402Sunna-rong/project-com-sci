...
import 'package:weatherlora/modelDate/humid2Date.dart';
import 'package:weatherlora/modelHour/humid2Hour.dart';
// ignore: unused_import
import 'package:weatherlora/modelHour/humidityHour.dart';
import 'package:http/http.dart' as http;
import 'package:intl/intl.dart';
import 'package:weatherlora/modelMonth/humid2Month.dart';
import 'package:month_picker_dialog/month_picker_dialog.dart';

// ignore: camel_case_types
class humid2 extends StatefulWidget {
  @override
...
// ignore: camel_case_types
class _humid2 extends State<humid2> {
  double value;
  DateTime day;
  String time;
  static List<Humid2Hour> uvhour;
  static List<Humid2Date> uvdate;
  static List<Humid2Month> uvMonth;

  Humid2Hour datastrH;
  Humid2Date datastrD;
  Humid2Month datastrM;
  ...
  _Hour() {
    ...
    features = [];
    strday = [];
    String url = 'http://202.28.34.197/db/humidity2_Date/' + strDate;
    print(strDate);
    print(url);
    http.get(url).then((response) {
      if (response.statusCode == 200) {
        uvhour = humid2HourFromJson(response.body);
        if (uvhour != null) {
  ...
  _Date() {
    ...
    features = [];
    strday = [];
    String urlpm1 = 'http://202.28.34.197/db/humidity2_month/$strDate';
    print(strDate);
    print(urlpm1);
    http.get(urlpm1).then((response) {
      if (response.statusCode == 200) {
        uvdate = humid2DateFromJson(response.body);
        if (uvdate != null) {
  ...
  _Month() {
    ...
    features = [];
    strday = [];
    String url = 'http://202.28.34.197/db/humidity2_month';
    http.get(url).then((response) {
      if (response.statusCode == 200) {
        uvMonth = humid2MonthFromJson(response.body);
        if (uvMonth != null) {
